...
public class StationTest {
	...
	public void testEnter() {
		...
		assertTrue("Enter failed to set Station as occupied", stationTest.isOccupied());
	}
	...
	public void testExit() {
		...
		assertFalse("Enter failed to set Station as unoccupied", stationTest.isOccupied());
	}
	...
	public void testIsOccupied() {
		...
		Line lineTest = new Line();
		Station stationTest = new Station("StatTest1",type, lineTest, capacity, position, id);
		assertFalse("Station set as occupied", stationTest.isOccupied());
		stationTest.setOccupiedTrue();
		assertTrue("Is occupied test Failed with true", stationTest.isOccupied());
	}
	...
	public void testSetOccupiedTrue() {
		...
		assertFalse("Station set as occupied", stationTest.isOccupied());
		stationTest.setOccupiedTrue();
		assertTrue("Failed to set occupied as true", stationTest.isOccupied());
	}
	...
	public void testSetOccupiedFalse() {
		...
		stationTest.setOccupiedTrue();
		assertTrue("Failed to set occupied as true", stationTest.isOccupied());
		stationTest.setOccupiedFalse();
		assertFalse("Failed to set occupied as false", stationTest.isOccupied());
